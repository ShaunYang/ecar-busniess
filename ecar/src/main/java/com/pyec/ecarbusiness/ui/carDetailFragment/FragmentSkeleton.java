...
public class FragmentSkeleton extends BaseFragment {
    ...
    //定义数组来存放Fragment界面  
    private Class fragmentArray[] = {FragmentSkeletonLeft.class,FragmentSkeletonRight.class};  
     
    //Tab选项卡的文字  
    private String mTextviewArray[] = {"左侧","右侧"};
